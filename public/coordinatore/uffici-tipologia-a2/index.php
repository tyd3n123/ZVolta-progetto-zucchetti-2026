...
// ── Prenotazioni attive utente (solo scrivanie A2) ─────
$userBookings = [];
$stmt = $conn->prepare(
...
<link rel="stylesheet" href="../../admin/uffici-tipologia-a2/uffici.css">
</head>
<body>
...
// ════════════════════════════════════════════════════════
// LAYOUT — 2 pod in alto (A,B) + 1 pod in basso (C)
// ════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════
// SCRIVANIE — Pod A, B (sopra) + Pod C (sotto)
// ════════════════════════════════════════════════════════
