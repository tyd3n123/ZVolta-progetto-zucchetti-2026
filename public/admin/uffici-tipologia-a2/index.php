...
$desks = [];
$result = $conn->query("SELECT id_asset, codice_asset, stato FROM asset WHERE id_tipologia=2 AND mappa='Sede' ORDER BY codice_asset");
if ($result) {
...
<div class="uf-page">
  ...
  <div class="uf-bookings-strip">
    ...
    <?php if (empty($userBookings)):?>
      <div class="uf-empty"><span>&#x1F5A5;&#xFE0F;</span><p>Nessuna prenotazione attiva</p></div>
    <?php else:?>
